...
var createJestEnvironment = Base => {
  ...
  function _getTestFullName(test) {
    ...
    var fullNamePath = (0, _reporter.getPosixPath)(this.testPath);
  ...
  function _handleTestStart(test) {
    ...
    var legacyTestId = (0, _utils.getTestId)(newTestSuitePath.concat(cleanTitle));
    var legacyFullName = "".concat((0, _reporter.getPosixPath)(this.testPath), "#").concat(legacyTestId);
    var newTestFullName = _assertClassBrand(_Class_brand, this, _getTestFullName).call(this, test, cleanTitle);
    if (this.testPlan && !(0, _reporter.includedInTestPlan)(this.testPlan, {
    ...
    var testUuid = this.runtime.startTest({
      ...
      labels: [(0, _reporter.getLanguageLabel)(), (0, _reporter.getFrameworkLabel)("jest"), (0, _reporter.getPackageLabel)(this.testPath), (0, _reporter.getFallbackTestCaseIdLabel)((0, _reporter.md5)(legacyFullName)), (0, _reporter.getHostLabel)(), (0, _reporter.getThreadLabel)(_nodeProcess.env.JEST_WORKER_ID), ...(0, _reporter.getEnvironmentLabels)(), ...(0, _reporter.getSuiteLabels)(newTestSuitePath), ...labels],
      titlePath,
      links
